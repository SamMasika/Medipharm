...
<v-container fluid class="my-1">
        ...
        <v-card-text>
            ...
            <v-row>
                ...
                <v-col cols="6" offset="6">
                    <v-btn type="submit" color="blue lighten-1" rounded="xl" elevation="0">
                        Submit
                    </v-btn>
                </v-col>
            </v-row>
    ...
    <v-card rounded="lg" class="my-5" flat>

        <v-card-title class="d-flex align-center  " dark>
...
<script>
import DatatableFooter from '../Layout/DatatableFooter.vue';
export default {
    components: {
        DatatableFooter
    },
