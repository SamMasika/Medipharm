<template>
    <v-container fluid>
            ...
            <v-col cols="12" md="auto" class="d-flex justify-end">
                <v-dialog v-model="dialog" max-width="600">
                    <template v-slot:activator="{ props: activatorProps }">
                        <v-btn class="text-none font-weight-regular button-color mb-5" prepend-icon="mdi-plus" text="Add Service Category" variant="flat" v-bind="activatorProps" rounded="xl"></v-btn>
                    </template>
                    <v-card prepend-icon="mdi-plus" title="Add Service Category">
                        <v-form>
                            <v-card-text>
                                <v-row dense>
        ...
        <v-card>
			...
			<DataTable :api-url="'service-category/list'" :headers="headers">
        ...
        <v-dialog v-model="confirmDialogVisible" max-width="450">
            <v-card class="rounded-lg elevation-16" style="background-color: #f9f9f9;">
                ...
                <v-card-actions class="justify-center py-4">
                    ...
                    <v-btn text variant="tonal" @click="deleteCategory" rounded="xl" color="red" style="font-family: 'Roboto', sans-serif; font-weight: 600;">
  ...
  components: { DataTable },
        ...
        methods: {
            ...
            addCategory() {
                ...
                axios.post('/service-category/create', data, {
                        headers: {
            ...
            deleteCategory() {
                axios.delete(`service-category/delete/${this.categoryToDelete.id}`)
                    .then(response => {
